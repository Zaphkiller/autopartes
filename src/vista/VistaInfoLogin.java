 ...
 * @author Natsu98fx
 */
public class VistaInfoLogin extends javax.swing.JDialog {
    Timer timer = null;
    TimerTask task;
    int i = 32;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaInfoLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaInfoLogin().setVisible(true);
            }
        });
    }
