 ...
 * @author Natsu98fx
 */
public class VistaSuccess extends javax.swing.JDialog {
    Timer timer = null;
    TimerTask task;
    int i = 32;
    ...
    private void initComponents() {
        ...
        btnAceptarSucess.setForeground(new java.awt.Color(0, 102, 0));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaSuccess.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaSuccess().setVisible(true);
            }
        });
    }
